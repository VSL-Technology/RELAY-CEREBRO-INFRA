...
SESSION_ID=$($NODE -e 'const crypto=require("crypto"); process.stdout.write(crypto.randomUUID())')
BODY="{\"sessionId\":\"$SESSION_ID\",\"ip\":\"192.168.1.100\",\"mac\":\"AA:BB:CC:DD:EE:FF\",\"router\":\"bus01\"}"
